...
switch ($thisFile) {
    case "index.php":
        ...
        $thisSideBarFile = 'content/summaries/home.txt';
        break;
    case "berenice.php":
        $thisPageTitle = "Edgar Allen Poe - Berenice";
        $thisSideBarFile = "content/summaries/berenice.txt";
        break;
    case "cask.php":
        $thisPageTitle = "Edgar Allen Poe - cask of amontillado";
        $thisSideBarFile = "content/summaries/cask of amontillado.txt";
        break;
    case "descent.php":
        $thisPageTitle = "Edgar Allen Poe - descent into the maelstrom";
        $thisSideBarFile = "content/summaries/descent into the maelstrom.txt";
        break;
    case "angel.php":
        $thisPageTitle = "Edgar Allen Poe - the angel of the odd";
        $thisSideBarFile = "content/summaries/the angel of the odd.txt";
        break;
}
?>
