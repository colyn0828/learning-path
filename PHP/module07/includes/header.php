...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4 fixed-top">
    <a class="navbar-brand" href="<?php echo BASE_URL ?>index.php"><i class="material-icons"
                                                                      style="font-size:36px">home</i></a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                ...
                <a class="nav-link" href="<?php echo BASE_URL ?>index.php">LIST CONTACTS</a>
            </li>
            <li class="nav-item active">
